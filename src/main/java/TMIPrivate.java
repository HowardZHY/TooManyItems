...
public class TMIPrivate
{
    ...
    public static Field NBTTagListRead = getPrivateField(NBTTagList.class, "a", "read");
    public static Field NBTTagListWrite = getPrivateField(NBTTagList.class, "a", "write");
